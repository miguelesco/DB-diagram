...
CREATE INDEX medical_historiy_id_asc ON invoices(medical_historiy_id ASC);
CREATE INDEX treatment_id_asc ON invoices_items(treatment_id ASC);
CREATE INDEX invoice_id_asc ON invoices_items(invoice_id ASC);
